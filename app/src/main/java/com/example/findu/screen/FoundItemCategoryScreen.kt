...
fun FoundItemCategoryScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("您捡到了什么？", fontWeight = FontWeight.Bold) },
...
fun CategoryCard(
    ...
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .height(150.dp) // 稍微加高一点
            .scale(scale)
            .clickable(
                interactionSource = interactionSource,
                indication = null, // 自定义反馈，这里主要是缩放，也可以用 default
                onClick = onClick
            ),
